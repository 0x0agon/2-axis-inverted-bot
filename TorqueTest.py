...
while True:
    ...
    output = troll.determineOutput(yAngle, 0)
    tDriver.driveMotors(output, troll.maxVoltage)
    #print 'filtered= ', yAngle, 'accel= ', pitchAngle, 'gyro= ', deltaGyroY 
    print 'Y accel= ', pitchAngle, 'X accel =', rollAngle
